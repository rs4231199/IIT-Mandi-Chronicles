...
class mainPost extends React.Component {
  ...
  retrieveData = async () => {
    try {
      ...
      let date = new Date();
      let date2 = new Date(date.getFullYear(), date.getMonth(), date.getDate(), 23, 59, 59, 0);
  ...
  render() {
    let alertmsg = "This event is added to calendar.";
    return (
      <View style={{ flex: 1 }}>
        ...
        { 
          ...
          <FlatList
            ...
            ListEmptyComponent={<Text style={{textAlign: 'center', marginBottom: 300 }}>No Upcoming Events</Text>}
